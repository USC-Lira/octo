...
def get_config(config_string="head_mlp_only,language_conditioned"):
    ...
    NAME_PREFIX = "bridge_88_trajs_octo_base-1.5_bs128_im1_headmlponly"

    max_steps = FieldReference(50000)
    window_size = FieldReference(default=1)

    config = dict(
        pretrained_path="/home/jesse/.cache/huggingface/hub/models--rail-berkeley--octo-base-1.5/snapshots/ee3c10e8edd6ce2e8b1e8744d3c6fba4097bed48",
        ...
        eval_interval=5000,
        save_interval=5000,
        save_dir="/home/jesse/jesse_octo_checkpoints/",
        seed=42,
        wandb=dict(
            project="jesse_finetune_octo",
            name=NAME_PREFIX,
            group=NAME_PREFIX,
            entity="clvr",
        ),
